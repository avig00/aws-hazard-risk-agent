...
IMPORTANT: FORBIDDEN geographic summary words — do NOT use "all", "only", "entirely", "dominated", "concentrated", or "exclusively" in any geographic description. Count the distinct state values in the RESULTS table before making any geographic observation. If even one row has a different state, you must acknowledge it. Use precise language: "8 of the top 10 counties are in California" not "all counties are in California." Never use outside knowledge about which states tend to be high-risk — base geographic observations solely on the state values present in the RESULTS rows."""
